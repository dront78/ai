...
# Creates a server certificate signed by a CA using ED25519
# Optimized for MIPS architecture
# Usage: ./generate_server_cert.sh --ca-cert CA_CERT --ca-key CA_KEY [--cn CN_NAME] [--cert-file CERT_PATH] [--key-file KEY_PATH]
...
# Generate ED25519 private key for server
echo "Generating ED25519 server private key..."
...
echo "Successfully created server certificate and key:"
